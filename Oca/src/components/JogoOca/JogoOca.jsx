...
export const Jogo5=()=>{
  ...
  const tirar = () => {
    ...
    ganar();
    (J === 1) ? setJ(2) : (J === 2) ? setJ(3) : (J === 3) ? setJ(4) : (J === 4) ? setJ(5): setJ(1);
  };
  const ganar = () => {
    if (j1 === 62 && j1 === j2 && j1 === j3 && j1 === j4 && j1 === j5) window.location.reload(false);
  }
  return <>
    <Test>
      <div className="tablero">
...
export default function Jogo () {
  ...
  const tirar=()=>{
    ...
    ganar();
    (J===0)?setJ(1):(J===1)?setJ(2):(J===2)?setJ(3):(J===3)?setJ(4):(J===4)?setJ(5):setJ(0);
  ...
  return <>
    <Test>
      <div className="tablero">
        ...
        <div id="c8" onClick={()=>{setinfo(Data[7].Text)}}>8</div>
        <div id="c9" onClick={()=>{setinfo(Data[8].Text)}}>9</div>
        <Chip color={"#ff00cc"} x={Data[casillas[0]].X[0]} y={Data[casillas[0]].Y}>1</Chip>
        <Chip color={"#ffff00"} x={Data[casillas[1]].X[1]} y={Data[casillas[1]].Y}>2</Chip>
        <Chip color={"#ff0000"} x={Data[casillas[2]].X[2]} y={Data[casillas[2]].Y}>3</Chip>
        <Chip color={"#00ff00"} x={Data[casillas[3]].X[3]} y={Data[casillas[3]].Y}>4</Chip>
        <Chip color={"#0000ff"} x={Data[casillas[4]].X[4]} y={Data[casillas[4]].Y}>5</Chip>
        <Chip color={"#00ccff"} x={Data[casillas[5]].X[5]} y={Data[casillas[5]].Y}>6</Chip>
      </div>
    </Test>
    <Res>
      <input type="button" value="+" className='btn' onClick={() => { tirar() }} /><br />
